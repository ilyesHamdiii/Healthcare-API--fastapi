...
class Appointment(Base):
    ...
    patient_id=Column(Integer,ForeignKey("users.id"),nullable=False,primary_key=True)
    doctor=relationship("Doctor",back_populates="appointments")
    doctor_id=Column(Integer,ForeignKey("doctors.id"),nullable=False,primary_key=True)

    appointment_time=Column(TIMESTAMP(timezone=True),nullable=False,primary_key=True)
